...
//and cookiemains for playtesting this mod, you can look at the cookiemains section to see what ideas he suggested
		...
		l('decayWidget').innerHTML = `<div id="decayCpsMult" `+Game.getTooltip('CpS multiplier from your decay', 'middle', false)+` class="widgetDisplay"><div class="icon widgetIcon toLeft" style="`+writeIcon([3, 1, custImg])+`"></div>`+`<div id="decayCpsData" class="widgetText">initializing...</div>`+`<div class="icon widgetIcon toRight" style="`+writeIcon([3, 1, custImg])+`"></div></div><br><div id="decayMomentum" `+Game.getTooltip('Decay rate multiplier from your momentum', 'middle', false)+` class="widgetDisplay"><div class="icon widgetIcon toLeft" style="`+writeIcon([5, 3, custImg])+`"></div>`+`<div id="decayMomentumData" class="widgetText">initializing...</div>`+`<div class="icon widgetIcon toRight" style="`+writeIcon([5, 3, custImg])+`"></div></div>`;
