...
//and cookiemains for playtesting this mod, you can look at the cookiemains section to see what ideas he suggested
		...
		l('decayWidget').innerHTML = `<div id="decayCpsMult" style="position: relative; display:inline-flex; width: 100%;"><div class="icon" style="position: absolute; left: 0px; `+writeIcon([3, 1, custImg])+`"></div>`+`<div id="decayCpsData" style="display: inline; margin: 4px 52px 4px 52px;">initializing...</div>`+`<div class="icon" style="position: absolute; right: 0px; `+writeIcon([3, 1, custImg])+`"></div></div><br><div id="decayMomentum" style="position: relative; display:inline-flex; width: 100%;"><div class="icon" style="position: absolute; left: 0px; `+writeIcon([5, 3, custImg])+`"></div>`+`<div id="decayMomentumData" style="display: inline; margin: 4px 52px 4px 52px;">initializing...</div>`+`<div class="icon" style="position: absolute; right: 0px; `+writeIcon([5, 3, custImg])+`"></div></div>`;
