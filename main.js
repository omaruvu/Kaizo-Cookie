...
//and cookiemains for playtesting this mod, you can look at the cookiemains section to see what ideas he suggested
		...
		addLoc('This Shimmering Veil is currently taking on %1 of your decay. <br><br>If it collapses, turning it back on will require <b>%2x</b> more cookies than usual, and you must wait for at least <b>%3</b> before doing so. <br>In addition, it will return <b>%4</b> of the decay it absorbed back onto you when it collapses.');
		Game.Upgrades['Shimmering veil [on]'].descFunc = function(){
			return (this.name=='Shimmering veil [on]'?'<div style="text-align:center;">'+loc("Active.")+'</div><div class="line"></div>':'')+loc("This Shimmering Veil is currently taking on %1 of your decay. <br><br>If it collapses, turning it back on will require <b>%2x</b> more cookies than usual, and you must wait for at least <b>%3</b> before doing so. <br>In addition, it will return <b>%4</b> of the decay it absorbed back onto you when it collapses.",[Beautify(Game.getVeilBoost()*100), (Game.getVeilCost(true)/Game.getVeilCost(false)).toFixed(2), Game.sayTime(Game.getVeilCooldown(),2), Beautify(Game.getVeilReturn())]);
		}
		addLoc('This Shimmering Veil is slowly healing itself. If activated, this veil will take on %1 of your decay. <br><br>If it collapses, turning it back on will require <b>%2x</b> more cookies than usual, and you must wait for at least <b>%3</b> before doing so. <br>In addition, it will return <b>%4</b> of the decay it absorbed back onto you when it collapses.');
		Game.Upgrades['Shimmering veil [off]'].descFunc = function(){
			return (this.name=='Shimmering veil [on]'?'<div style="text-align:center;">'+loc("Active.")+'</div><div class="line"></div>':'')+loc("This Shimmering Veil is slowly healing itself. If activated, this veil will take on %1 of your decay. <br><br>If it collapses, turning it back on will require <b>%2x</b> more cookies than usual, and you must wait for at least <b>%3</b> before doing so. <br>In addition, it will return <b>%4</b> of the decay it absorbed back onto you when it collapses.",[Beautify(Game.getVeilBoost()*100), (Game.getVeilCost(true)/Game.getVeilCost(false)).toFixed(2), Game.sayTime(Game.getVeilCooldown(),2), Beautify(Game.getVeilReturn())]);
		} 
